...
public class Target extends GraphicsProgram{
     ...
     public void run() {
         ...
         drawCircle(centerWidth - TARGET_WIDTH / 2,centerHeight - TARGET_HEIGHT / 2,TARGET_WIDTH,TARGET_HEIGHT, Color.RED);
         drawCircle(centerWidth - (TARGET_WIDTH *.65) / 2,centerHeight - (TARGET_HEIGHT * .65) / 2,TARGET_WIDTH * .65,TARGET_HEIGHT * .65, Color.WHITE);
         drawCircle(centerWidth - (TARGET_WIDTH *.3) / 2,centerHeight - (TARGET_HEIGHT * .3) / 2,TARGET_WIDTH * .3,TARGET_HEIGHT * .3, Color.RED);
     }
